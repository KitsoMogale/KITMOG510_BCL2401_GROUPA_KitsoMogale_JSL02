...
const addNewGoal = () => {
  ...
  // get the goalList object's children elements length
  //use it in the for loop to iterate through the 'li' elements
  
    for(let i = 0;i< goalList.children.length;i++){

        //check if the content of each existing 'li' element is is the same as the input value 
